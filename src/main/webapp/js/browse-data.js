fx_NDVI_MAP = {
    ...
    init : function() {
        ...
        var m1 = fx_NDVI_MAP.createNigeriaMap('map1', layer);
        ...
        var m2 = fx_NDVI_MAP.createNigeriaMap('map2', layer);
        ...
        var m3 = fx_NDVI_MAP.createNigeriaMap('map3', layer);
        ...
        var m4 = fx_NDVI_MAP.createNigeriaMap('map4', layer);
