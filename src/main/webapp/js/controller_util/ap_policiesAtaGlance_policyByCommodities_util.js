var ap_policiesAtaGlance_policyByCommodities_util = (function() {
    ...
    function subMenu0(){
        $("#bd5_submenu0_row_option").affix({
            offset: { top: $("#bd5_submenu0_row_option").offset().top }
        });

        // ensure the affix element maintains it width
        var affix = $("#bd5_submenu0_row_option");
        var width = affix.width();
        affix.width(width);
        //From and To Calendars
        $("#bd5_submenu0-slider_2").jqxDateTimeInput();
        $("#bd5_submenu0-slider_3").jqxDateTimeInput();
        ...
        $("#bd5_submenu0-commodity_list").jqxComboBox({ source: source, selectedIndex: 0, height: '25px'});
        //$("#bd5_submenu0_row").sticky({classname:'is-sticky', wrapperClassName: 'sticky-wrapper'});
       // $("#bd5_submenu0_row_option").sticky({topSpacing:0});
    }
...
//        $("#bd5_submenu1-slider_2").jqxDateTimeInput();
//        $("#bd5_submenu1-slider_3").jqxDateTimeInput();

        //Commodity list box
//        var source = new Array();
//        source[i] = { html: html, title: title };
        //Chart
       // $('#bd5_submenu1-chart_one').highcharts({
        $('#bd5_submenu1-chart_one').highcharts({
            chart: {
                type: 'column',
                borderWidth: 2
            ...
            subtitle: {
                text: 'Source: Amis Policy --- Period '+ from+'/'+to
            },
            xAxis: {
                categories: [
                    '1',
...
//                    '<td style="padding:0"><b>{point.y:.1f} mm</b></td></tr>',
            ...
            legend: {
                title: {
                   // text: 'Policy Measure Type --- Selected Commodity',
                    text: 'Policy Measure Type<br/><span style="color: #666; font-weight: normal">(Selected Commodity)</span>',
                    style: {
                        fontStyle: 'italic'
                    }
                },
...
//                    var html_legend = '<table><tr><td><b>'+this.name+': </b></td><td>'+ split_string(pmt_name_description[this.name])+'</td></tr></table>';
//                    return html_legend;

                    var categ = this.xAxis.categories;
//                    var html_legend = '<dl><dt><b>'+this.name+'</b></dt><dd> :'+ pmt_name_description[this.name]+'</dd></dl>';
                    //return this.name +' ('+pmt_name_description[this.name]+')';
                    var html_legend ='<table>';
                    for(var i=0; i< categ.length; i++)
                    {
                        html_legend += '<tr><td valign="top"><b>'+categ[i]+': </b></td><td>'+ split_string(pmt_name_description[categ[i]])+'</td></tr>';
                    }
                    html_legend += '</table>';
                    //alert("leg "+html_legend);
                    return html_legend;
                }
            },
            credits: {
...
//            "PMT4"
//        ];
        //$("#bd5_submenu2-pmt_list").jqxComboBox({ source: source, selectedIndex: 0, width: '100%', height: '25px'});
//        $("#bd5_submenu2-radioButton_one").jqxRadioButton({ width: 250, height: 25, checked: true, groupName :'bd5_submenu2_rbgroup'});
//        $("#bd5_submenu2-radioButton_two").jqxRadioButton({ width: 250, height: 25, groupName :'bd5_submenu2_rbgroup'});
//        $("#bd5_submenu2-radioButton_three").jqxRadioButton({ width: 250, height: 25, groupName :'bd5_submenu2_rbgroup'});
//        $("#bd5_submenu2-radioButton_four").jqxRadioButton({ width: 250, height: 25, groupName :'bd5_submenu2_rbgroup'});
        $("#bd5_submenu2-radioButton_one").jqxRadioButton({ height: 25, checked: true, groupName :'bd5_submenu2_rbgroup'});
        $("#bd5_submenu2-radioButton_two").jqxRadioButton({ height: 25, groupName :'bd5_submenu2_rbgroup'});
        $("#bd5_submenu2-radioButton_three").jqxRadioButton({ height: 25, groupName :'bd5_submenu2_rbgroup'});
        $("#bd5_submenu2-radioButton_four").jqxRadioButton({ height: 25, groupName :'bd5_submenu2_rbgroup'});

        //Chart
        $('#bd5_submenu2-chart_one').highcharts({
            chart: {
                type: 'column',
                borderWidth: 2
            },
...
//                    '<td style="padding:0"><b>{point.y:.1f} mm</b></td></tr>',
            ...
            legend: {
                title: {
                    // text: 'Policy Measure Type --- Selected Commodity', when the user select PMT and commodity store this info in variables and then
                    //here call that variable calling also split_string for PMT
                    text: 'Policy Measure<br/><span style="color: #666; font-weight: normal">(Selected Commodity/Selected PMT)</span>',
                    style: {
                        fontStyle: 'italic'
                    }
                },
...
//                    var html_legend = '<dl><dt><b>'+this.name+'</b></dt><dd> :'+ pmt_name_description[this.name]+'</dd></dl>';
                    ...
                    for(var i=0; i< categ.length; i++)
                    {
                        html_legend += '<tr><td valign="top"><b>'+categ[i]+': </b></td><td>'+ split_string(pm_name_description[categ[i]])+'</td></tr>';
                    }
                    html_legend += '</table>';
                    //alert("leg "+html_legend);
                    return html_legend;
...
//                    }
            ...
            series: [{
                //name: 'Selected Commodity/Selected PMT',
                name:'1',
                data: [49.5, 93.3, 47.2, 60.5, 42.4, 75.8, 42, 57.9]
    ...
    function subMenu4(){
        ...
        //Chart
        $('#bd5_submenu3-chart_one').highcharts({
            title: {
                text: 'Time Series Chart 3',
                x: -20 //center
            },
            subtitle: {
                text: 'Source: Amis Policy --- Period '+ from+'/'+to,
            ...
            series: [{
                name: 'PMT1/Selected Commodity',
                data: [7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
            }, {
                name: 'PMT2/Selected Commodity',
                data: [-0.2, 0.8, 5.7, 11.3, 17.0, 22.0, 24.8, 24.1, 20.1, 14.1, 8.6, 2.5]
            }, {
                name: 'PMT3/Selected Commodity',
                data: [-0.9, 0.6, 3.5, 8.4, 13.5, 17.0, 18.6, 17.9, 14.3, 9.0, 3.9, 1.0]
            }, {
                name: 'PMT4/Selected Commodity',
    ...
    function subMenu3(){
        ...
        seriesOptions.push({
            ...
            data: [
                ...
                /* Apr 2013 */
                [1364774400000,465.91],
                [1364860800000,464.79],
                [1364947200000,463.99],
                [1365033600000,462.72],
                [1365120000000,461.20],
                [1365379200000,460.21],
                [1365465600000,459.98],
                [1365552000000,458.69],
                [1365638400000,457.33],
                [1365724800000,456.80],
                [1365984000000,455.85],
                [1366070400000,454.24],
                [1366156800000,453.80],
                [1366243200000,452.05],
                [1366329600000,451.53],
                [1366588800000,450.67],
                [1366675200000,449.13],
                [1366761600000,448.46],
                [1366848000000,447.38],
                [1366934400000,446.20],
                [1367193600000,445.12],
                [1367280000000,444.78],
                /* May 2013 */
                [1367366400000,876.29],
                [1367452800000,875.52],
                [1367539200000,874.98],
                [1367798400000,873.71],
                [1367884800000,872.66],
                [1367971200000,871.84],
                [1368057600000,870.77],
                [1368144000000,869.97]
            ]
        });
        ...
        seriesOptions.push({
            ...
            data: [
                ...
                [1365984000000,565.85],
                [1366070400000,656.24],
                [1366156800000,6.80],
                [1366243200000,45.05],
                [1366329600000,564.53],
                [1366588800000,564.67],
                [1366675200000,6.13],
                [1366761600000,45.46],
                [1366848000000,56.38],
                [1366934400000,456.20],
                [1367193600000,35.12],
                [1367280000000,44.78],
                /* May 2013 */
                [1367366400000,234.29],
                [1367452800000,45.52],
                [1367539200000,43.98],
                [1367798400000,45.71],
                [1367884800000,45.66],
        ...
        seriesOptions.push({
            ...
            data: [
                ...
                [1364428800000,442.66],
                /* Apr 2013 */
                [1364774400000,978.91],
                [1364860800000,786.79],
                [1364947200000,786.99],
                [1365033600000,786.72],
                [1365120000000,675.20],
                [1365379200000,567.21],
                [1365465600000,788.98],
                [1365552000000,466.69],
                [1365638400000,675.33],
                [1365724800000,454.80],
                [1365984000000,345.85],
                [1366070400000,787.24],
                [1366156800000,786.80],
                [1366243200000,878.05],
                [1366329600000,657.53],
                [1366588800000,353.67],
                [1366675200000,989.13],
                [1366761600000,989.46],
                [1366848000000,656.38],
                [1366934400000,456.20],
                [1367193600000,675.12],
                [1367280000000,768.78],
                /* May 2013 */
                [1367366400000,345.29],
                [1367452800000,656.52],
                [1367539200000,345.98],
                [1367798400000,687.71],
                [1367884800000,564.66],
                [1367971200000,897.84],
                [1368057600000,678.77],
                [1368144000000,450.97]
            ]
        });
        ...
        function createChart() {
            ...
            $('#bd5_submenu3-chart_one').highcharts('StockChart', {
                chart: {
                    borderWidth: 2
                },
...
//                            return (this.value > 0 ? '+' : '') + this.value + '%';
                ...
                title : {
                    text : 'Time Series of the frequency of the Policy Measure Type'
                },
...
//window.addEventListener('load', ap_policiesAtaGlance_policyByCommodities_util.init, false);
